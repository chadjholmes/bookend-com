      ...
      <nav className="relative z-10 container mx-auto px-6 py-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-8">
            ...
            <Link href="#" className="text-white/80 hover:text-white text-sm font-medium">Book Clubs</Link>
            <Link href="#" className="text-white/80 hover:text-white text-sm font-medium">Reading Stats</Link>
            <Link href="#" className="text-white/80 hover:text-white text-sm font-medium">Community</Link>
            <Link href="#" className="text-white/80 hover:text-white text-sm font-medium">Login</Link>
            <Link 
              href="#" 
              className="bg-white/10 text-white px-4 py-2 rounded-lg hover:bg-white/20 text-sm font-medium backdrop-blur-sm"
            >
              Start Reading
            </Link>
          </div>
